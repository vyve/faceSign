package com.cin.facesign.widget.voiceline;
...
public class VoiceLineView extends View {
    ...
    private float rectInitHeight = 15;
    ...
    private void initAtts(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.VoiceLineView);
        ...
        maxVolume = typedArray.getFloat(R.styleable.VoiceLineView_maxVolume, 100);
        sensibility = typedArray.getInt(R.styleable.VoiceLineView_sensibility, 4);
        if (mode == RECT) {
            rectWidth = typedArray.getDimension(R.styleable.VoiceLineView_rectWidth, 15);
            rectSpace = typedArray.getDimension(R.styleable.VoiceLineView_rectSpace, 5);
            rectInitHeight = typedArray.getDimension(R.styleable.VoiceLineView_rectInitHeight, 10);
        } else {
            middleLineColor = typedArray.getColor(R.styleable.VoiceLineView_middleLine, Color.BLACK);
            middleLineHeight = typedArray.getDimension(R.styleable.VoiceLineView_middleLineHeight, 4);
    ...
    public void setVolume(int volume) {
        ...
        LogUtils.i("音量,"+volume+","+targetVolume);
    }
