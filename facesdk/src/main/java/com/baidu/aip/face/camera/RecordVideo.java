...
public class RecordVideo {
    ...
    /**
     * A to prevent the app from exiting before closing the camera.
     */
    ...
    public RecordVideo(Activity activity, TextureView mTextureView) {
...
//        }
        mMediaRecorder.setOutputFile(Environment.getExternalStorageDirectory() + "/recordVideo.mp4");
    ...
    private void configureTransform(int viewWidth, int viewHeight) {
        ...
        RectF bufferRect = new RectF(0, 0, mTextureView.getHeight(), mTextureView.getWidth());
    ...
    /**
     * Update the camera preview. needs to be called in advance.
     */
